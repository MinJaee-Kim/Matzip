...
public class KakaoSearchAdapter extends RecyclerView.Adapter<KakaoSearchAdapter.CustomViewHolder> {
    ...
    public KakaoSearchAdapter(Context context, ArrayList<BoardListModel> arraylist) {
    ...
    @Override
    public void onBindViewHolder(@NonNull KakaoSearchAdapter.CustomViewHolder holder, int position) {
    ...
    private void select_photo(@NonNull KakaoSearchAdapter.CustomViewHolder holder, Integer bo_id) {
    ...
    private void getCommentList(@NonNull KakaoSearchAdapter.CustomViewHolder holder, int board_id) {
