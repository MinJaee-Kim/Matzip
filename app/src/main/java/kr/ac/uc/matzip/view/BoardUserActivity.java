...
public class BoardUserActivity extends AppCompatActivity implements PullRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_board_layout);

        loading = (PullRefreshLayout)findViewById(R.id.swipeRefreshLayout);
        mRecyclerView = (RecyclerView)findViewById(R.id.ublay_rv);
        ...
        Button board_backBtn = (Button) findViewById(R.id.ublay_backBtn);
        board_backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void GetBoardList() {
        ...
        boardAPI.getUserBoard(getIntent().getIntExtra("user_id", 0)).enqueue(new Callback<List<BoardListModel>>() {
            @Override
            public void onResponse(Call<List<BoardListModel>> call, Response<List<BoardListModel>> response) {
                ...
                mBoardListAdapter = new BoardListAdapter(BoardUserActivity.this,arrayList);
